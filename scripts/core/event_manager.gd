...
func create_arrival_event(system: StarSystemData, cosmic_signature: int) -> ArrivalEventData:
	...
	if system.threat_level >= 50 or cosmic_signature >= 10:
	...
	if system.threat_level >= 75 or cosmic_signature >= 50:
